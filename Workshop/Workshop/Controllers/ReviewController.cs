...
//                 var review = await _reviewService.AddReviewAsync(userId, request.BookId, request.OrderId, request.Rating, request.Comment);

//                 if (review == null)
//                 {
//                     return BadRequest(new { message = "Review could not be added. Ensure you completed the order and purchased this book." });
//                 }
...
//             catch (Exception ex)
//             {
//                 Console.WriteLine("🔥 Error in AddReview: " + ex.Message);  // Log error to console
